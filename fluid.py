            ...
            for j in range(self.width):
                ...
                if i == 0:
                    ...
                    divergence = \
                        ...
                        + self.v_grid[i][j] \
                        - self.v_grid[i][j+1]
                    aux_u_gird[i][j] -= self.u_grid[i][j]
                    aux_u_gird[i+1][j] += divergence/3
                    aux_v_gird[i][j] -= divergence/3
                    aux_v_gird[i][j+1] += divergence/3
                    ...
                    divergence = \
                        ...
                        + self.v_grid[i][j] \
                        - self.v_grid[i][j+1]
                    aux_u_gird[i][j] -= divergence/3
                    aux_u_gird[i+1][j] = self.u_grid[i+1][j]
                    aux_v_gird[i][j] -= divergence/3
                    aux_v_gird[i][j+1] += divergence/3
                    x = self.v_grid[i][j] + self.v_grid[i][j+1]
                    y = self.u_grid[i][j] + self.u_grid[i+1][j]
